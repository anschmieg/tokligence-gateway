...
RUN npm ci --omit=dev
COPY tgw-proxy.mjs openai-stream.mjs sanitize-headers.mjs smart-router.mjs quota-tracker.mjs routing-profiles.mjs routing-planner.mjs request-executor.mjs provider-adapters.mjs protocol-codecs.mjs ./
