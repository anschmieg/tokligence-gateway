...
export const ROUTING_PROFILES = {
  ...
  primary: {
    ...
    providers: [
      ...
      { id: "copilot-auto", models: ["copilot-auto"], weight: 70, billing_class: "subscription" },
  ...
  auxiliary: {
    ...
    web_extraction: {
      ...
      providers: [
        ...
        { id: "mistral", models: ["mistral-small-latest"], weight: 75, billing_class: "subscription" },
      ],
      fallback_strategy: "round_robin",
      max_retries: 2,
    ...
    vision: {
      ...
      providers: [
        ...
        { id: "mistral", models: ["pixtral-large-latest"], weight: 95, billing_class: "subscription" },
        ...
        { id: "mistral", models: ["pixtral-12b-latest"], weight: 80, billing_class: "subscription" },
      ],
      fallback_strategy: "round_robin",
      max_retries: 2,
      capabilities: ["vision"],
  ...
  cron: {
    ...
    providers: [
      ...
      { id: "opencode-zen", models: ["kimi-k2.6-free"], weight: 85, billing_class: "free" },
      { id: "mistral", models: ["mistral-small-latest"], weight: 65, billing_class: "subscription" },
      { id: "copilot-auto", models: ["copilot-auto"], weight: 60, billing_class: "subscription" },
      { id: "openrouter", models: ["deepseek/deepseek-v4-flash-0731"], weight: 50, billing_class: "payg" },
    ],
    fallback_strategy: "weighted_random",
    max_retries: 3,
